...
//Implement the shader program creation mechanism. The function also attaches and links the shader program:
...
//Create a function to handle the initialization. This function is a helper function that handles requests from the Java side:
...
//Set up the rendering function that draws a triangle on the screen with red, green, and blue vertices:
//vertices
...
extern "C" {
  JNIEXPORT void JNICALL Java_com_android_gl3jni_gl3jnidemo_GL3JNILib_init(JNIEnv * env, jobject obj, jint width, jint height);
  JNIEXPORT void JNICALL Java_com_android_gl3jni_gl3jnidemo_GL3JNILib_step(JNIEnv * env, jobject obj);
  JNIEXPORT void JNICALL Java_com_android_gl3jni_gl3jnidemo_GL3JNILib_runCommand (JNIEnv *, jclass, jstring);
};

JNIEXPORT void JNICALL Java_com_android_gl3jni_gl3jnidemo_GL3JNILib_init
